...
export function About() {
  return (
    <section className="mx-auto sm:mb-10 max-w-7xl">
      ...
      <div className=" flex flex-col sm:px-8 gap-4 sm:flex-row-reverse items-center">
        <img className="sm:max-w-[461px]" src={imgCat} alt="" />
        <div className="flex flex-col mb-8 gap-4 text-gray max-w-[466px] px-2">
      ...
      <div className=" flex flex-col sm:px-8 gap-4 sm:mt-10 sm:flex-row items-center">
        <img className="sm:max-w-[463px]" src={imgStoreDog} alt="" />

        <p className=" text-gray mb-8 max-w-[466px] px-2">
